...
export type PropRef = Expression<ExpressionType.PropRef, Record<"name", string>>;
export type OfRef = Expression<ExpressionType.OfRef, Record<"key", string> & Record<"prop", string>>;
